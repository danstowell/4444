...
It provides a simple framework for making generative dance music, and presumably other sorts 
of music, anything that you can code in supercollider and comes in 4-bar patterns of 4.

You just need to define some Patterns (or more interestingly, some Functions that return 
Patterns), and probably some SynthDefs of your own.

The system has its own notion of its current mood ('arousal' and 'valence') which the 
Functions can use to generate happy/sad/chill/angry patterns accordingly.

The included 'example' files are simple generative examples that might help you get started.



The general approach: 
Each channel (bass, snare, hats, whatever) is a data structure stored in a Dictionary, having:
